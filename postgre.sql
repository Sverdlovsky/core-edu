CREATE DB OMH;
CREATE USER OMH_User WITH PASSWORD 'SET_YOUR_PASSWORD';
ALTER DATABASE OMH OWNER TO OMH_User;


CREATE TYPE unit_type AS ENUM ('movie', 'season', 'special', 'documentary');
CREATE TYPE relation_type AS ENUM ('prequel', 'sequel', 'spinoff', 'side_story');
CREATE TYPE locale_type AS ENUM ('en-US', 'ru-RU');
