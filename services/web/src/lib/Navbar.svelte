...
<div class="navbar">
    <a href="/" style="width: 192px; grid-area: home;">
        <img
            src={`https://media.${$domain}/icons/${$theme}/favicon.svg`}
            alt="ico"
    ...
    <a href="/favorites" style="grid-area: favorites;">
        <img
            src={`https://media.${$domain}/icons/${$theme}/favorites.svg`}
            alt="ico"
        />
    </a>
    <a href="/settings" style="grid-area: settings;">
        <img
            src={`https://media.${$domain}/icons/${$theme}/settings.svg`}
            alt="ico"
        />
    </a>
    <a href={`https://auth.${$domain}/with/yandex`} style="grid-area: profile;">
        <img
            src={`https://media.${$domain}/icons/${$theme}/profile.svg`}
            alt="ico"
        />
    </a>
</div>
